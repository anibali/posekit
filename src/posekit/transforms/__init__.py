...
class ZoomImage(Transform):
    ...
    def add_camera_transform(self, ctx):
        ctx.camera_transformer.mm(mat3.scale(self.sx, self.sy))

    def add_image_transform(self, ctx):
        ctx.image_transformer.mm(mat3.scale(self.sx, self.sy))
...
class ChangeResolution(Transform):
    ...
    def add_image_transform(self, ctx):
        ...
        ctx.image_transformer.mm(mat3.scale(scale[0], scale[1]))
